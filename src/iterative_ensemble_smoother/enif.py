...
Create probelm size with parameters >> responses >> realizations.
    ...
    def __init__(
        ...
        *,
        ...
        parameter_precision: sp.sparse.sparray
            ...
            Can either be estimated from the data X, with shape (num_parameters, ensemble_size)
        ...
        self.spd_solver = SPDSolver(Prec_x=parameter_precision,
                                    solver=self.solver,
